...
export const featureArray = [{
    ...
    noMessage: `${user.name}, this is not one of those freaky one-eyed aliens!`
}, {
    id: 'twoEyes',
    ...
    yesMessage: `${user.name}, have you ever seen a three-eyed alien? You will...`,
    noMessage: `This one does not have three eyes.`
}, {
    id: 'fourEyes',
